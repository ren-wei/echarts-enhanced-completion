...
~[780x900](https://echarts.apache.org/examples/zh/view.html?c=tree-basic&edit=1&reset=1)


**径向布局示例：**

~[800x800](https://echarts.apache.org/examples/zh/view.html?c=tree-radial&edit=1&reset=1)
...
```
其中第一个参数 `value` 为 [data](~series-tree.data) 中的数据值。第二个参数`params` 是其它的数据项参数。


## symbolSize(number|Array|Function) = 7
