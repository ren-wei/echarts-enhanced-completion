...
图形的颜色。 默认从全局调色盘 [option.color](~color) 获取颜色。从 5.2.0 开始支持在`emphasis`状态中支持设置为`'inherit'`取消高亮颜色。
...
## animationDurationUpdate(number|Function) = 500
