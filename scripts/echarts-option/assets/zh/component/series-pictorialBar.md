...
+ `'cartesian2d'`
    ...
    使用二维的直角坐标系（也称笛卡尔坐标系），通过 [xAxisIndex](~series-pictorialBar.xAxisIndex), [yAxisIndex](~series-pictorialBar.yAxisIndex)指定相应的坐标轴组件。
...
例子：
~[600x400](doc-example/barGrid-barGap&reset=1&edit=1)
...
例子：
~[800x400](doc-example/pictorialBar-graphicType&reset=1&edit=1)



此属性可以被设置在系列的 [根部](~series-pictorialBar.symbol)，表示对此系列中所有数据都生效；也可以被设置在 [data](series-pictorialBar.data) 中的 [每个数据项中](~series-pictorialBar.data.symbol)，表示只对此数据项生效。
...
## symbolSize(number|Array) = ['100%', '100%']
...
例子：
~[800x600](doc-example/pictorialBar-symbolSize&reset=1&edit=1)



此属性可以被设置在系列的 [根部](~series-pictorialBar.symbolSize)，表示对此系列中所有数据都生效；也可以被设置在 [data](series-pictorialBar.data) 中的 [每个数据项中](~series-pictorialBar.data.symbolSize)，表示只对此数据项生效。
...
例子：
~[800x600](doc-example/pictorialBar-position&reset=1&edit=1)



此属性可以被设置在系列的 [根部](~series-pictorialBar.symbolPosition)，表示对此系列中所有数据都生效；也可以被设置在 [data](series-pictorialBar.data) 中的 [每个数据项中](~series-pictorialBar.data.symbolPosition)，表示只对此数据项生效。
...
此属性可以被设置在系列的 [根部](~series-pictorialBar.symbolOffset)，表示对此系列中所有数据都生效；也可以被设置在 [data](series-pictorialBar.data) 中的 [每个数据项中](~series-pictorialBar.data.symbolOffset)，表示只对此数据项生效。
...
此属性可以被设置在系列的 [根部](~series-pictorialBar.symbolRotate)，表示对此系列中所有数据都生效；也可以被设置在 [data](series-pictorialBar.data) 中的 [每个数据项中](~series-pictorialBar.data.symbolRotate)，表示只对此数据项生效。
...
例子：
~[800x400](doc-example/pictorialBar-repeat&reset=1&edit=1)



此属性可以被设置在系列的 [根部](~series-pictorialBar.symbolRepeat)，表示对此系列中所有数据都生效；也可以被设置在 [data](series-pictorialBar.data) 中的 [每个数据项中](~series-pictorialBar.data.symbolRepeat)，表示只对此数据项生效。
...
## symbolRepeatDirection(string) = 'start'
...
例子：
~[800x400](doc-example/pictorialBar-repeatDirection&reset=1&edit=1)



此属性可以被设置在系列的 [根部](~series-pictorialBar.symbolRepeatDirection)，表示对此系列中所有数据都生效；也可以被设置在 [data](series-pictorialBar.data) 中的 [每个数据项中](~series-pictorialBar.data.symbolRepeatDirection)，表示只对此数据项生效。
...
例子：
~[800x600](doc-example/pictorialBar-repeatLayout&reset=1&edit=1)



此属性可以被设置在系列的 [根部](~series-pictorialBar.symbolMargin)，表示对此系列中所有数据都生效；也可以被设置在 [data](series-pictorialBar.data) 中的 [每个数据项中](~series-pictorialBar.data.symbolMargin)，表示只对此数据项生效。
...
例子：
~[800x600](doc-example/pictorialBar-clip&reset=1&edit=1)
...
此属性可以被设置在系列的 [根部](~series-pictorialBar.symbolClip)，表示对此系列中所有数据都生效；也可以被设置在 [data](series-pictorialBar.data) 中的 [每个数据项中](~series-pictorialBar.data.symbolClip)，表示只对此数据项生效。
...
## symbolBoundingData(number|Array)
...
参见例子：
~[800x400](doc-example/pictorialBar-symbolBoundingDataArray&reset=1&edit=1)



此属性可以被设置在系列的 [根部](~series-pictorialBar.symbolBoundingData)，表示对此系列中所有数据都生效；也可以被设置在 [data](series-pictorialBar.data) 中的 [每个数据项中](~series-pictorialBar.data.symbolBoundingData)，表示只对此数据项生效。
...
例子：
~[800x400](doc-example/pictorialBar-patternSize&reset=1&edit=1)



此属性可以被设置在系列的 [根部](~series-pictorialBar.symbolPatternSize)，表示对此系列中所有数据都生效；也可以被设置在 [data](series-pictorialBar.data) 中的 [每个数据项中](~series-pictorialBar.data.symbolPatternSize)，表示只对此数据项生效。
...
此属性可以被设置在系列的 [根部](~series-pictorialBar.hoverAnimation)，表示对此系列中所有数据都生效；也可以被设置在 [data](series-pictorialBar.data) 中的 [每个数据项中](~series-pictorialBar.data.hoverAnimation)，表示只对此数据项生效。
...
~[800x500](doc-example/bar-polar-label-radial-multiple&reset=1&edit=1)

~[800x500](doc-example/bar-polar-label-tangential-multiple&reset=1&edit=1)
...
```
其中第一个参数 `value` 为 [data](~series-pictorialBar.data) 中的数据值。第二个参数`params` 是其它的数据项参数。
...
1. 通过 [x](~series-pictorialBar.markPoint.data.x), [y](~series-pictorialBar.markPoint.data.y) 属性指定相对容器的屏幕坐标，单位像素，支持百分比。


2. 用 [coord](~series-pictorialBar.markPoint.data.coord) 属性指定数据在相应坐标系上的坐标位置，单个维度支持设置 `'min'`, `'max'`, `'average'`。

3. 直接用 [type](~series-pictorialBar.markPoint.data.type) 属性标注系列中的最大值，最小值。这时候可以使用 [valueIndex](~series-pictorialBar.markPoint.data.valueIndex) 或者 [valueDim](~series-pictorialBar.markPoint.data.valueDim) 指定是在哪个维度上的最大值、最小值、平均值。
...
在使用 [type](~series-pictorialBar.markPoint.data.type) 时有效，用于指定在哪个维度上指定最大值最小值，可以是 `0`（xAxis, radiusAxis），`1`（yAxis, angleAxis），默认使用第一个数值轴所在的维度。

#### valueDim(string)

在使用 [type](~series-pictorialBar.markPoint.data.type) 时有效，用于指定在哪个维度上指定最大值最小值。这可以是维度的直接名称，例如折线图时可以是`x`、`angle`等、candlestick 图时可以是`open`、`close`等维度名称。
...
标线两端的标记类型，可以是一个数组分别指定两端，也可以是单个统一指定，具体格式见 [data.symbol](~series-pictorialBar.markLine.data.0.symbol)。
...
1. 通过 [x](~series-pictorialBar.markLine.data.0.x), [y](~series-pictorialBar.markLine.data.0.y) 属性指定相对容器的屏幕坐标，单位像素，支持百分比。


2. 用 [coord](~series-pictorialBar.markLine.data.0.coord) 属性指定数据在相应坐标系上的坐标位置，单个维度支持设置 `'min'`, `'max'`, `'average'`。

3. 直接用 [type](~series-pictorialBar.markLine.data.0.type) 属性标注系列中的最大值，最小值。这时候可以使用 [valueIndex](~series-pictorialBar.markLine.data.0.valueIndex) 或者 [valueDim](~series-pictorialBar.markLine.data.0.valueDim) 指定是在哪个维度上的最大值、最小值、平均值。
...
在使用 [type](~series-pictorialBar.markLine.data.type) 时有效，用于指定在哪个维度上指定最大值最小值，可以是 `0`（xAxis, radiusAxis），`1`（yAxis, angleAxis），默认使用第一个数值轴所在的维度。

##### valueDim(string)

在使用 [type](~series-pictorialBar.markLine.data.type) 时有效，用于指定在哪个维度上指定最大值最小值。这可以是维度的直接名称，例如折线图时可以是`x`、`angle`等、candlestick 图时可以是`open`、`close`等维度名称。
...
1. 通过 [x](~series-pictorialBar.markArea.data.0.x), [y](~series-pictorialBar.markArea.data.0.y) 属性指定相对容器的屏幕坐标，单位像素，支持百分比。


2. 用 [coord](~series-pictorialBar.markArea.data.0.coord) 属性指定数据在相应坐标系上的坐标位置，单个维度支持设置 `'min'`, `'max'`, `'average'`。

3. 直接用 [type](~series-pictorialBar.markArea.data.0.type) 属性标注系列中的最大值，最小值。这时候可以使用 [valueIndex](~series-pictorialBar.markArea.data.0.valueIndex) 或者 [valueDim](~series-pictorialBar.markPoint.data.0.valueDim) 指定是在哪个维度上的最大值、最小值、平均值。
...
在使用 [type](~series-pictorialBar.markArea.data.type) 时有效，用于指定在哪个维度上指定最大值最小值，可以是 `0`（xAxis, radiusAxis），`1`（yAxis, angleAxis），默认使用第一个数值轴所在的维度。

##### valueDim(string)

在使用 [type](~series-pictorialBar.markArea.data.type) 时有效，用于指定在哪个维度上指定最大值最小值。这可以是维度的直接名称，例如折线图时可以是`x`、`angle`等、candlestick 图时可以是`open`、`close`等维度名称。
