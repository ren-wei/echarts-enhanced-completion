...
~[800x400](https://echarts.apache.org/examples/zh/view.html?c=bar-background&reset=1&edit=1)
...
### color(Color) = \'rgba(180, 180, 180, 0.2)\'
...
柱条的颜色。 默认从全局调色盘 [option.color](~color) 获取颜色。   在`emphasis`状态中支持设置为`'inherit'`取消高亮。 
...
## largeThreshold(number) = 400

<ExampleUIControlNumber min="1" default="400" />
...
## progressiveChunkMode(string) = mod
